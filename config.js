...
exports.exceptions = {
	'digitaledge': true, 'savioredge': true, 'edgejs': true, 'havingfun98': true,'lostcause146': true,'magentia':true,'lordbeerus35':true, 'bnowlin1999':true,'shinyhunter712':true,'acharizardfan':true,'temmiechang':true,
	// 'userid': true
};
...
exports.globalPermissions = {
	...
	'roomvoice': '+', //Min rank to broadcast in a server
...
exports.initBattleMsg = ['Gooood luck'];

exports.winmsg = ['ggm8'];

exports.losemsg = ['rigged af ;-;'];
